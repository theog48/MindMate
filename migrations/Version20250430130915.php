 ...
 */
final class Version20250430130915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_FDCA8C9CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE quizz (id INT AUTO_INCREMENT NOT NULL, cours_id INT NOT NULL, user_id INT NOT NULL, titre VARCHAR(255) NOT NULL, question1 VARCHAR(255) NOT NULL, reponse11 VARCHAR(255) NOT NULL, reponse12 VARCHAR(255) NOT NULL, reponse13 VARCHAR(255) NOT NULL, bonnereponse1 VARCHAR(255) NOT NULL, userreponse1 VARCHAR(255) DEFAULT NULL, question2 VARCHAR(255) NOT NULL, reponse21 VARCHAR(255) NOT NULL, reponse22 VARCHAR(255) NOT NULL, reponse23 VARCHAR(255) NOT NULL, bonne_reponse2 VARCHAR(255) NOT NULL, reponse_user2 VARCHAR(255) DEFAULT NULL, question3 VARCHAR(255) NOT NULL, reponse31 VARCHAR(255) NOT NULL, reponse32 VARCHAR(255) NOT NULL, reponse33 VARCHAR(255) NOT NULL, bonne_reponse3 VARCHAR(255) NOT NULL, reponse_user3 VARCHAR(255) DEFAULT NULL, question4 VARCHAR(255) NOT NULL, reponse41 VARCHAR(255) NOT NULL, reponse42 VARCHAR(255) NOT NULL, reponse43 VARCHAR(255) NOT NULL, bonne_reponse4 VARCHAR(255) NOT NULL, reponse_user4 VARCHAR(255) DEFAULT NULL, question5 VARCHAR(255) NOT NULL, reponse51 VARCHAR(255) NOT NULL, reponse52 VARCHAR(255) NOT NULL, reponse53 VARCHAR(255) NOT NULL, bonne_reponse5 VARCHAR(255) NOT NULL, reponse_user5 VARCHAR(255) DEFAULT NULL, score VARCHAR(255) DEFAULT NULL, INDEX IDX_7C77973D7ECF78B0 (cours_id), INDEX IDX_7C77973DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, nb_token INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', has_test_premium TINYINT(1) NOT NULL, date_fin_premium DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
