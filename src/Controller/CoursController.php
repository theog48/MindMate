                        ...
                        [
                            ...
                            'json' => [
                                "messages" => [
                                    [
                                        "role" => "user",
                                        "content" => "Je veux un cours sur le sujet suivant : $title. Voici le contenu du cours à résumer et à simplifier : $description. Je voudrais également 5 questions de type QCM avec 3 choix possible et je voudrais également la bonne réponse. fais moi une réponse sous forme de json dont voici un exemple :{
                                    [\"cours\"]=> {
